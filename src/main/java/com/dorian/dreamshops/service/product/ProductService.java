...
import com.dorian.dreamshops.exceptions.ProductNotFoundException;
...
import com.dorian.dreamshops.repository.CategoryRepository;
import com.dorian.dreamshops.repository.ImageRepository;
import com.dorian.dreamshops.repository.ProductRepository;
...
public class ProductService implements IProductService {
    ...
    public Product updateProductById(ProductUpdateRequest request, Long productId) {
        return productRepository.findById(productId)
                .map(existingProduct -> udateExistingProduct(existingProduct, request))
                .map(productRepository::save)
                .orElseThrow(() -> new ProductNotFoundException("Product not found!!"));

    }

    private Product udateExistingProduct(Product existingProduct, ProductUpdateRequest request) {
